...
it before any recording starts. The notice appears before your browser's own
microphone prompt, so you see what the audio is for before you are asked to
...
Declining is always possible: close the notice and no recording starts and no
audio is captured. You can withdraw consent afterwards by deleting your account
(§4), which erases your transcripts and scores along with it.
